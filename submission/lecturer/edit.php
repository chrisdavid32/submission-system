      ...
      <div class="container-fluid">
         ...
         <div class="card mb-3">
            <div class="row">
               ...
               <div class="col-lg-6">
                  <?php
                  include('coursepatch.php');
                  ?>
                  <form method="post" enctype="multipart/form-data">
                     <div class="card mb-3">
                        <div class="card-header">
                           <i class="fa fa-book"></i>Upload Assignment</div>
                        <div class="card-body">
                           <div class="row">
                              <div class="col-md-10" style="margin-top:0px">
                                 <label for="exampleInputName">Due Date</label>
                                 <input class="form-control" id="exampleInputName" type="date" name="due_date" value="<?php print($data['date']); ?>" />
                                 <br />
                              </div>
                              <div class="col-md-10" style="margin-top:0px">
                                 <label for="exampleInputName">Due Time</label>
                                 <input class="form-control" id="exampleInputName" type="time" name="due_time" value="<?php print($data['time']); ?>" />
                                 <br />
                              </div>
                              <div class="col-md-12" style="margin-top:0px" align="center">
                                 <button class="btn btn-success" name="submit"><i class="fa fa-sign-in"></i> &nbsp;Update</button>
                              </div>
                           </div>
                        </div>
