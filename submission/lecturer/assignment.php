                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-8" style="margin-top:0px">
                      ...
                      <input class="form-control" id="exampleInputName" type="date" name="due_date" />
                      <br />
                    </div>
                    <div class="col-md-8" style="margin-top:0px">
                      <label for="exampleInputName">Due Time</label>
                      <input class="form-control" id="exampleInputName" type="time" name="due_time" />
                      <br />
                    </div>
                    <div class="col-md-12" style="margin-top:0px">
                      <label for="exampleInputName">Upload File</label>
                      <input class="form-control" id="exampleInputName" type="file" name="file1" />
                      <br />
                    </div>
