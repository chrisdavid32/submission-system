          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $data = "select * from staff order by staff_id ASC";
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      ?>
                      <td><?php print ucwords(($quy['staff_id'])); ?></td>
                      <td><?php print (ucwords($quy['tit'])) . '.&nbsp;' . (ucfirst($quy['last_name'])) . '&nbsp;' . (ucfirst($quy['other_name'])); ?></td>
